...
<main class="mx-10 my-10 max-w-3xl">
	...
	<div>
		...
		<input
			type="email"
			class="w-full border border-brand-primary px-3 py-2 text-brand-primary focus:ring-2 focus:ring-brand-primary/30 focus:outline-none"
	...
	<div class="flex items-center gap-3 ">
		...
		<button class="text-sm text-gray-600 hover:cursor-pointer" on:click={() => goto('/')}
			>{$_('contact.cancel')}
		</button>
	</div>
</main>
